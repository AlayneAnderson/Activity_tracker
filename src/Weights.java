...
public class Weights extends list_node {
    ...
    public Weights(Weights a_weights) {
        material = a_weights.material;
    }
    ...
    public void display() {
        ...
        if (material != null) {
            System.out.println("Equipment needed is: " + material);
        } else
            System.out.println("No equipment type set yet.");
    ...
    public int change_materials() {
        ...
        System.out.println("What is the required equipment for this subject?:");
        material = input.nextLine();

        if (material != null) {
            System.out.println("Equipment needed: " + material);
            return 0;
        } else
    ...
    public int change_description() {
        ...
        Scanner input = new Scanner(System.in);
        System.out.println("What equipment are needed for this project? :");
        material = input.nextLine();

        if (material != null) {
            System.out.println("Equipment set to: " + material);
            return 0;
        } else
            //in main remember to handle this case
            return -1;
