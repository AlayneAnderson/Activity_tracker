...
public class Cardio extends list_node {
    ...
    public void display() {
        ...
        if (type != null) {
            System.out.println("The cardio type needed is: " + type);
        } else
            System.out.println("No cardio type set yet.");
    ...
    public int change_materials() {
        ...
        System.out.println("What is the required cardio type?:");
        type = input.nextLine();

        if (type != null) {
            System.out.println("Cardio type needed: " + type);
            return 0;
        } else
    ...
    public int change_description() {
        ...
        Scanner input = new Scanner(System.in);
        System.out.println("What cardio type's are needed for this project? :");
        type = input.nextLine();

        if (type != null) {
            System.out.println("Cardio type set to: " + type);
            return 0;
        } else
            //in main remember to handle this case
            return -1;
